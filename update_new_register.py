...
class Delete_achievement:
    ...
    def batch_delete_new_register_(self, promotionId_list:list):
        for promotionId in promotionId_list:
            print(promotionId)
            URL="http://sit-admin2.tcg.com/tac/api/relay/put/mcs-internal-v3-registerPromotion-editStatus"
            header={
                "accept":"*/*",
            ...
            respone=requests.put(URL,headers=header, json=payload,verify=False)
    ...
    def get_new_register_list(self, delete_name:str):
        URL="http://sit-admin2.tcg.com/tac/api/relay/get/mcs-internal-promotion-searchGeneralPromotionList"
        header={
            "accept":"*/*",
            "Accept-Encoding":"gzip, deflate, br",
            "merchantCode": "gi8viet",
...
def main():
    ...
    try:
        ...
        if b_end.token:
            promotionId_list = b_end.get_new_register_list("test")
